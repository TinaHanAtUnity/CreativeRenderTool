...
| streaming | boolean | If ad request is done at show time for immediate streaming | SDK | all |
...
| streaming | all | True | False | boolean | If ad request is done at show time for immediate streaming | SDK | all |
