...
const SERVER_ADDRESS = "http://localhost:8000/build/browser/index.html?headlessloadadapter=1";
...
const REQUIRED_MESSAGES = [
    ...
    {description: "Configuration Response",
        ...
        expected: 1,
        matchedMessages: []},
    {description: "Placement State Changed rewardedVideo: waiting",
        regexp:  new RegExp(/onUnityAdsPlacementStateChanged: rewardedVideo NOT_AVAILABLE -> WAITING/),
        seen: 0,
        expected: 1,
        matchedMessages: []},
    {description: "Placement State Changed rewardedVideo: ready",
        regexp:  new RegExp(/onUnityAdsPlacementStateChanged: rewardedVideo WAITING -> READY/),
        seen: 0,
        expected: 1,
        matchedMessages: []}];
