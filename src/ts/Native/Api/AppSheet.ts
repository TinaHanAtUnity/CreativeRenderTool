...
export class AppSheetApi extends NativeApi {
    ...
    public onPrepared: Observable1<IAppSheetOptions> = new Observable1<IAppSheetOptions>();
    public onOpen: Observable1<IAppSheetOptions> = new Observable1<IAppSheetOptions>();
    public onClose: Observable1<IAppSheetOptions> = new Observable1<IAppSheetOptions>();
    public onError: Observable2<string, IAppSheetOptions> = new Observable2<string, IAppSheetOptions>();
