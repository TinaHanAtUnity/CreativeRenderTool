...
import { AndroidPermission, AndroidPermissionsApi } from 'Native/Api/AndroidPermissions';
import { IosPermission, IosPermissionsApi } from 'Native/Api/IosPermissions';
...
export class PermissionsApi extends NativeApi {
    ...
    private checkIosPermission(permission: PermissionTypes): Promise<CurrentPermission> {
        ...
        return this._ios.checkPermission(iosPermission).then(results => {
