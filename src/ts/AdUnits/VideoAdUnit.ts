...
export abstract class VideoAdUnit extends AbstractAdUnit {
    ...
    public show(): Promise<void> {
        ...
        return this._container.open(this, true, true, this._placement.useDeviceOrientationForVideo() ? ForceOrientation.NONE : ForceOrientation.LANDSCAPE, this._placement.disableBackButton(), false, true, false, this._options);
    }
