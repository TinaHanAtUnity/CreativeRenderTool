...
export class VideoAdUnitController {
    ...
    private _overlay: VideoOverlay | undefined;
    ...
    constructor(nativeBridge: NativeBridge, adUnit: AdUnit, placement: Placement, campaign: Campaign, overlay: VideoOverlay, options: any) {
    ...
    public getOverlay(): VideoOverlay | undefined {
