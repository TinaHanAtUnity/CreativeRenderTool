...
import {
    VastAdUnitWithClickThroughURL,
    VastAdUnitWithoutClickThroughURL
} from 'VAST/AdUnits/__mocks__/VastAdUnit';
    ...
    describe('TencentVastOverlayEventHandler', () => {
        ...
        describe('when call button get clicked and there is no click through url', () => {
            it('the error message should be returned to indicate the url is null',  () => {
                vastTencentOverlayHandler = new TencentVastOverlayEventHandler(new VastAdUnitWithoutClickThroughURL(), baseParams);
        ...
        describe('when call button get clicked and there is valid click through url', () => {
            ...
            beforeEach(async () => {
                ...
                vastTencentOverlayHandler = new TencentVastOverlayEventHandler(new VastAdUnitWithClickThroughURL(), baseParams);
