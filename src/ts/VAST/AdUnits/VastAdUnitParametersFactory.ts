        ...
        if (adVerifications) {
            ...
            adVerifications.forEach((adverification) => {
                ...
                if (CustomFeatures.isIASVendor(adverification.getVerificationVendor())) {
                    const om = new OpenMeasurement(baseParams.platform, baseParams.core, baseParams.clientInfo, baseParams.campaign, baseParams.placement, baseParams.deviceInfo, baseParams.request, baseParams.thirdPartyEventManager, adverification.getVerificationVendor(), adverification);
