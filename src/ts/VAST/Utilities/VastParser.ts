...
export class VastParser {
    ...
    private parseCreativeCompanionAdElement(companionAdElement: Element): VastCreativeCompanionAd | null {
        ...
        if (companionAdElement && staticResourceElement) {
            ...
            return new VastCreativeCompanionAd(id, height, width, creativeType, staticResourceURL, companionClickThroughURLTemplate, companionClickTrackingURLTemplates, trackingEvents);
        } else {
            return null;
        }
    }
