...
export class PlayableEndScreen extends View {
    ...
    constructor(nativeBridge: NativeBridge, campaign: MRAIDCampaign, coppaCompliant: boolean, language: string) {
    ...
    private getEndscreenAlt(campaign: MRAIDCampaign) {
        return undefined;
    }
