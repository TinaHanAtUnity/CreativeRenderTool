...
import { GdprBaseAbTest, IABGroup } from 'Models/ABGroup';
...
export abstract class EndScreen extends View<IEndScreenHandler> implements IPrivacyHandler {
    ...
    private _abGroup: IABGroup;
    private _showGDPRBanner: boolean = false;
    private _gdprPopupClicked = false;
    private _campaignId: string | undefined;
    private _osVersion: string | undefined;

    constructor(nativeBridge: NativeBridge, language: string, gameId: string, gameName: string | undefined, abGroup: IABGroup, privacy: AbstractPrivacy, showGDPRBanner: boolean, adUnitStyle?: AdUnitStyle, campaignId?: string, osVersion?: string) {
