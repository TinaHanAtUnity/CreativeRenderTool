...
export class CampaignManager {
    ...
    public request(nofillRetry?: boolean): Promise<INativeResponse | void> {
        ...
        return Promise.all([this.createRequestUrl(false, nofillRetry), this.createRequestBody(countersForOperativeEvents, requestPrivacy, nofillRetry)]).then(([requestUrl, requestBody]) => {
    ...
    public requestRealtime(placement: Placement, session: Session): Promise<Campaign | void> {
        return Promise.all([this.createRequestUrl(true, undefined, session), this.createRequestBody(session.getGameSessionCounters(), session.getPrivacy(), false, placement)]).then(([requestUrl, requestBody]) => {
    ...
    public loadCampaign(placement: Placement, timeout: number): Promise<ILoadedCampaign | undefined> {
        ...
        return Promise.all([this.createRequestUrl(false), this.createRequestBody(countersForOperativeEvents, requestPrivacy, false, undefined, placement), this._deviceInfo.getFreeSpace()]).then(([requestUrl, requestBody, deviceFreeSpace]) => {
    ...
    private createRequestBody(gameSessionCounters: IGameSessionCounters, requestPrivacy?: IRequestPrivacy, nofillRetry?: boolean, realtimePlacement?: Placement, requestedPlacement?: Placement): Promise<unknown> {
