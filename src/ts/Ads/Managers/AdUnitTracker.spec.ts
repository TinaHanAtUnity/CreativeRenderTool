...
describe('AdUnitTracker', () => {
    ...
    beforeEach(() => {
        ...
        adUnitTracker = new AdUnitTracker('admob', loadApi, storageApi, listenerApi, trackableRefreshManager);
    });
    ...
    describe('send missed impression', () => {
        ...
        it('should send metric events', () => {
            expect(ProgrammaticTrackingService.reportMetricEventWithTags).toBeCalledTimes(1);
            expect(ProgrammaticTrackingService.reportMetricEventWithTags).toHaveBeenNthCalledWith(1, AdUnitTracking.MissedImpression, [undefined]);
        });
    });
    ...
    describe('send impression', () => {
        ...
        it('should send metric events', () => {
            expect(ProgrammaticTrackingService.reportMetricEventWithTags).toBeCalledTimes(1);
            expect(ProgrammaticTrackingService.reportMetricEventWithTags).toHaveBeenNthCalledWith(1, AdUnitTracking.MediationShowCall, [undefined]);
        });
    });
