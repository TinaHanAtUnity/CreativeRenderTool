...
export class AssetManager {
    ...
    constructor(cache: Cache, cacheMode: CacheMode, deviceInfo: DeviceInfo, cacheBookkeeping: CacheBookkeeping, nativeBridge: NativeBridge, backupCampaignManager: BackupCampaignManager) {
        this._cache = cache;
