...
export class RequestPrivacyFactory {
    ...
    private static GameUsesConsent(gamePrivacy: GamePrivacy) {
        return gamePrivacy.getMethod() === PrivacyMethod.UNITY_CONSENT || gamePrivacy.getMethod() === PrivacyMethod.DEVELOPER_CONSENT;
    }
