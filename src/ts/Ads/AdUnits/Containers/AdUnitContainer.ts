...
export abstract class AdUnitContainer {
    ...
    public abstract open(adUnit: AbstractAdUnit | string, views: string[], allowRotation: boolean, forceOrientation: Orientation, disableBackbutton: boolean, isTransparent: boolean, withAnimation: boolean, allowStatusBar: boolean, options: unknown): Promise<void>;
