...
export class MixedPlacementUtility {
    ...
    public static shouldFillMixedPlacement(placementId: string, configuration: CoreConfiguration, campaign: Campaign): boolean {
    ...
    public static insertMediaIdsIntoJSON(configuration: CoreConfiguration, jsonPlacements: { [placementName: string]: string }): { [placementName: string]: string } {
    ...
    private static extractMixedPlacementSuffix(placementId: string, campaign: Campaign, configuration: CoreConfiguration): MixedPlacementTypes {
    ...
    private static hasMixedPlacementSuffix(placementId: string, configuration: CoreConfiguration): boolean {
