...
export class NewVideoOverlay extends AbstractVideoOverlay implements IPrivacyHandler {
    ...
    constructor(platform: Platform, ads: IAdsApi, muted: boolean, language: string, gameId: string, privacy: AbstractPrivacy, showGDPRBanner: boolean, abGroup: ABGroup, showPrivacyDuringVideo?: boolean, seatId?: number) {
        super(platform, 'new-video-overlay', muted);
