...
export class PerformanceVideoOverlayWithCTAButton extends NewVideoOverlay implements IPrivacyHandler {
    ...
    constructor(platform: Platform, ads: IAdsApi, muted: boolean, language: string, gameId: string, privacy: AbstractPrivacy, showGDPRBanner: boolean, campaign: PerformanceCampaign, disablePrivacyDuringVideo?: boolean, seatId?: number) {
        super(platform, ads, muted, language, gameId, privacy, showGDPRBanner, disablePrivacyDuringVideo, seatId);
