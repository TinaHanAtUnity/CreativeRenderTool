...
describe('MRAID', () => {
    ...
    it('should render', (done) => {
        const campaign = new MRAIDCampaign({id: '123abc'}, '123456', 1, undefined, undefined, `<script src="mraid.js"></script><div>Hello</div>`);
    ...
    it('should replace placeholder with dynamic markup injected', () => {
        const campaign = new MRAIDCampaign({id: '123abc', dynamicMarkup: 'InjectMe'}, '123456', 1, undefined, undefined, `<script src="mraid.js"></script><script>{UNITY_DYNAMIC_MARKUP}</script><div>Hello</div>`);
        const mraid = new MRAID(nativeBridge, placement, campaign);
    ...
    it('should remove the mraid.js placeholder when it has a query parameter', () => {
        ...
        const campaign = new MRAIDCampaign({id: '123abc', dynamicMarkup: 'InjectMe'}, '123456', 1, undefined, undefined, markup);
        const mraid = new MRAID(nativeBridge, placement, campaign);
