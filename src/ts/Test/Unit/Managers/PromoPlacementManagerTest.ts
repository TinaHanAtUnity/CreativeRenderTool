...
// import { PromoPlacementManager } from 'Managers/PlacementManager';
...
//             promoPlacementManager.addAuctionFillPlacementId('testid');
...
//             let placements = promoPlacementManager.getAuctionFillPlacementIds();
//             expect(placements).to.have.length(0);
//             promoPlacementManager.addAuctionFillPlacementId('testid');
//             placements = promoPlacementManager.getAuctionFillPlacementIds();
//             expect(Object.keys(placements)).to.have.length(1);
//             assert.deepEqual(promoPlacementManager.getAuctionFillPlacementIds(), ['testid']);
//         });
//     });
