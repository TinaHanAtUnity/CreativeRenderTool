...
describe('CampaignManager', () => {
    ...
    describe('on PLC', () => {
        ...
        beforeEach(() => {
            ...
            campaignManager.onPlcCampaign.subscribe((placement: String, campaign: Campaign) => {
                triggeredCampaign = campaign;
        ...
        describe('performance campaign', () => {
            it('should process correct Auction comet/performance Campaign content type', () => {
                ...
                return campaignManager.request().then(() => {
                    ...
                    assert.equal((<PerformanceCampaign>triggeredCampaign).getVideo().getUrl(), 'http://s3-us-west-1.amazonaws.com/ads-load-testing/AssetPack1/video1-landscape.mp4');
                });
            });
