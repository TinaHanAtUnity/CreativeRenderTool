...
export class TestFixtures {
    public static getDisplayInterstitialCampaign(): DisplayInterstitialCampaign {
        ...
        return new DisplayInterstitialCampaign(json.display.markup, json.display.markupUrl, json.display.markupBaseUrl, this.getSession(), json.gamerId, json.abGroup, undefined, json.display.tracking, json.display.clickThroughURL);
    }
