...
describe('MRAIDEventHandlersTest', () => {
    ...
    describe('with onClick', () => {
        ...
        it('should send a click with session manager', () => {
            ...
            sinon.assert.calledWith(<sinon.SinonSpy>operativeEventManager.sendClick, mraidCampaign.getSession(), placement);
        });

        it('should send a view with session manager', () => {
            mraidEventHandler.onMraidClick('http://example.net');
            sinon.assert.calledWith(<sinon.SinonSpy>operativeEventManager.sendView, mraidCampaign.getSession(), placement);
        });

        it('should send a third quartile event with session manager', () => {
            mraidEventHandler.onMraidClick('http://example.net');
            sinon.assert.calledWith(<sinon.SinonSpy>operativeEventManager.sendThirdQuartile, mraidCampaign.getSession(), placement);
        });
