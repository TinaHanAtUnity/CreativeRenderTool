...
describe('AndroidAdUnitTest', () => {
    ...
    describe('should open ad unit', () => {
        ...
        it('with all options true', () => {
            return container.open(testAdUnit, true, true, ForceOrientation.LANDSCAPE, true, false, true, { requestedOrientation: ScreenOrientation.SCREEN_ORIENTATION_UNSPECIFIED }).then(() => {
        ...
        it('with all options false', () => {
            ...
            return container.open(testAdUnit, false, false, ForceOrientation.NONE, false, false, true, { requestedOrientation: ScreenOrientation.SCREEN_ORIENTATION_SENSOR_LANDSCAPE }).then(() => {
    ...
    describe('should handle Android lifecycle', () => {
        ...
        it('with onResume', () => {
            ...
            return container.open(testAdUnit, true, true, ForceOrientation.LANDSCAPE, true, false, true, options).then(() => {
