...
export class WebView {
    ...
    public initialize(): Promise<void | any[]> {
        ...
        return this._nativeBridge.Sdk.loadComplete().then((data) => {
            ...
            this._backupCampaignManager = new BackupCampaignManager(this._nativeBridge, this._configuration);
            this._assetManager = new AssetManager(this._cache, this._configuration.getCacheMode(), this._deviceInfo, this._cacheBookkeeping, this._nativeBridge, this._backupCampaignManager);
