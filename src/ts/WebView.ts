...
export class WebView {
    ...
    public initialize(): Promise<void | any[]> {
        ...
        return this._nativeBridge.Sdk.loadComplete().then((data) => {
            ...
            this._nativeBridge.Purchasing.onIAPSendEvent.subscribe((iapPayload) => PurchasingUtilities.handleSendIAPEvent(this._nativeBridge, iapPayload));
            ...
            PurchasingUtilities.campaignManager = this._campaignManager;
