...
export class AuctionRequest {
    ...
    private static TestModeUrl: string = 'https://auction.staging.unityads.unity3d.com/v4/test/games';
    private static TestModeV5Url: string = 'https://auction.staging.unityads.unity3d.com/v5/test/games';
    ...
    constructor(params: IAuctionRequestParams) {
        ...
        if(this._coreConfig.getTestMode()) {
            this._baseURL = AuctionV5Test.isValid(this._coreConfig.getAbGroup()) ? AuctionRequest.TestModeV5Url : AuctionRequest.TestModeUrl;
        } else {
