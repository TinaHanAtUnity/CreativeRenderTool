...
export class VideoInfo {
    public static isValid(nativeBridge: NativeBridge, cache: Cache, video: Video, reportErrors: boolean): Promise<boolean> {
        return cache.getFileId(video.getOriginalUrl()).then(fileId => {
