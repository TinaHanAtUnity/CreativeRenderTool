...
export class ProgrammaticVastParser extends CampaignParser {
    ...
    protected parseVastToCampaign(vast: Vast, nativeBridge: NativeBridge, campaignId: string, session: Session, gamerId: string, abGroup: IABGroup, response: AuctionResponse): Promise<Campaign> {
