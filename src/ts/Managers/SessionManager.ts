...
export class SessionManager {
    ...
    public sendStart(adUnit: AbstractAdUnit): Promise<void> {
        ...
        return this._metaDataManager.fetch(PlayerMetaData).then(player => {
            ...
            return this._eventMetadataCreator.createUniqueEventMetadata(adUnit, this._currentSession, this._gamerServerId, this.getPreviousPlacementId()).then(fulfilled);
        });
    }
