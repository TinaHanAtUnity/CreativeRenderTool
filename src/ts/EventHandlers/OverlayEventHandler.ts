...
export class OverlayEventHandler<T extends Campaign> implements IOverlayHandler {
    ...
    public onOverlaySkip(position: number): void {
        ...
        this._operativeEventManager.sendSkip(this._campaign.getSession(), this._placement, this._adUnit.getVideo().getPosition(), this.getVideoOrientation(), this._adUnitStyle);
    ...
    public onOverlayClose(): void {
        ...
        this._adUnit.setActive(false);
        this._adUnit.setFinishState(FinishState.SKIPPED);
        this._operativeEventManager.sendSkip(this._campaign.getSession(), this._placement, this._adUnit.getVideo().getPosition(), this.getVideoOrientation());
