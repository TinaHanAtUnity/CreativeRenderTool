...
describe('VideoEventHandlersTest', () => {
    ...
    describe('with onVideoCompleted', () => {
        ...
        beforeEach(() => {
            ...
            sinon.stub(testMetaData, 'get').returns(prom);
        });

        it('should set video to inactive', () => {
            VideoEventHandlers.onVideoCompleted(nativeBridge, sessionManager, adUnit, testMetaData);
    ...
    describe('with onVideoPrepared', () => {
        ...
        it('should set video duration for overlay', () => {
            VideoEventHandlers.onVideoPrepared(nativeBridge, adUnit, 10, testMetaData);
        ...
        it('should set debug message to programmatic ad if the ad unit is VAST', () => {
            ...
            VideoEventHandlers.onVideoPrepared(nativeBridge, vastAdUnit, 10, testMetaData);
