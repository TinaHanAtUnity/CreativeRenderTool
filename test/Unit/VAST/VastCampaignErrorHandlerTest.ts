...
describe('VastCampaignErrorHandlerTest', () => {
    ...
    describe('on handleCampaignError', () => {
        ...
        const campaignError = new CampaignError('Undefined Error', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.MEDIUM, VastErrorCode.UNKNOWN_ERROR, [errorUrl1, errorUrl2, errorUrl3], 'https://asset-url.com');
    ...
    describe('on handleCampaignError with multiple Errors compounded', () => {
        ...
        const campaignError1 = new CampaignError('Undefined First Error', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.MEDIUM, VastErrorCode.UNKNOWN_ERROR, [errorUrl1], 'https://asset-url.com');

        const campaignError2 = new CampaignError('Undefined Second Error', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.MEDIUM, VastErrorCode.UNKNOWN_ERROR, [errorUrl2], 'https://asset-url.com');

        const campaignError3 = new CampaignError('Undefined Third Error', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.LOW, VastErrorCode.UNKNOWN_ERROR, [errorUrl3], 'https://asset-url.com');

        const campaignErrorTotal = new CampaignError('Groupd of campaign errors', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.MEDIUM, VastErrorCode.XML_PARSER_ERROR, ['https://total-errors.com']);
