...
describe('VastCampaignErrorHandlerTest', () => {
    ...
    describe('on handleCampaignError', () => {
        ...
        const campaignError = new CampaignError('Undefined Error', CampaignContentTypes.ProgrammaticVast, CampaignErrorLevel.MID, VastErrorCode.UNKNOWN_ERROR, [errorUrl1, errorUrl2, errorUrl3], 'https://asset-url.com');
