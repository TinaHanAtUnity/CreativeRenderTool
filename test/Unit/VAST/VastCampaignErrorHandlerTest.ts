...
describe('VastCampaignErrorHandlerTest', () => {
    ...
    describe('on handleCampaignError with multiple Errors compounded', () => {
        it('should fire correct VAST error tracking urls with macro replaced for compounded campaignErrors', () => {
            ...
            const campaignError1 = new CampaignError('Undefined First Error', ProgrammaticVastParser.ContentType, CampaignErrorLevel.MEDIUM, VastErrorCode.UNKNOWN_ERROR, [errorUrl1], 'https://asset-url.com');

            const campaignError2 = new CampaignError('Undefined Second Error', ProgrammaticVastParser.ContentType, CampaignErrorLevel.MEDIUM, VastErrorCode.UNKNOWN_ERROR, [errorUrl2], 'https://asset-url.com');

            const campaignError3 = new CampaignError('Undefined Third Error', ProgrammaticVastParser.ContentType, CampaignErrorLevel.LOW, VastErrorCode.UNKNOWN_ERROR, [errorUrl3], 'https://asset-url.com');

            const campaignErrorTotal = new CampaignError('Groupd of campaign errors', ProgrammaticVastParser.ContentType, CampaignErrorLevel.MEDIUM, VastErrorCode.XML_PARSER_ERROR, ['https://total-errors.com']);
