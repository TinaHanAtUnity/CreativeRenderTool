...
describe('Vast', () => {
    ...
    describe('when VAST has a companion ad', () => {
        it('should return url for landscape endcard image', () => {
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 320, 480, 'image/png', 'http://url.com/landscape.png', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id2', 480, 320, 'image/png', 'http://url.com/portrait.png', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id3', 700, 800, 'image/png', 'http://image.com', 'https://url.com/click'));
            const vast = new Vast([vastAd], []);
        ...
        it('should not return url for portrait endcard if dimensions are too small', () => {
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 490, 319, 'image/png', 'http://url.com/portrait.png', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 479, 350, 'image/png', 'http://url.com/portrait.png', 'https://url.com/click'));
            const vast = new Vast([vastAd], []);
            assert.equal(vast.getCompanionPortraitUrl(), null);
        });

        it('should not return image urls when image mime types are not supported', () => {
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 320, 480, 'application/json', 'http://url.com/landscape.png', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id2', 480, 320, 'js', 'http://url.com/portrait.png', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id3', 700, 800, 'blah', 'http://image.com', 'https://url.com/click'));
            const vast = new Vast([vastAd], []);
            assert.equal(vast.getCompanionLandscapeUrl(), null);
            assert.equal(vast.getCompanionPortraitUrl(), null);
        });
        ...
        it('should return image urls when image mime type is jpeg or jpg', () => {
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 320, 480, 'image/jpeg', 'http://url.com/landscape.jpeg', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id2', 480, 320, 'image/jpg', 'http://url.com/portrait.jpg', 'https://url.com/click'));
            const vast = new Vast([vastAd], []);
        ...
        it('should return image urls when image mime type is gif', () => {
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id1', 320, 480, 'image/gif', 'http://url.com/landscape.gif', 'https://url.com/click'));
            vastAd.addCompanionAd(new VastCreativeStaticResourceCompanionAd('id2', 480, 320, 'image/gif', 'http://url.com/portrait.gif', 'https://url.com/click'));
            const vast = new Vast([vastAd], []);
