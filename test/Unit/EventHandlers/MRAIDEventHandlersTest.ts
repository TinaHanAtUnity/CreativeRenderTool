...
describe('MRAIDEventHandlersTest', () => {
    ...
    describe('with onClick', () => {
        ...
        beforeEach(() => {
            ...
            playableMraidAdUnitParams = {
                ...
                mraid: mraidView,
                endScreen: undefined,
                privacy: new GDPRPrivacy(nativeBridge, playableMraidCampaign, gdprManager, true, false, true),
    ...
    describe('with Programmatic MRAID', () => {
        ...
        beforeEach(() => {
            ...
            privacy = new GDPRPrivacy(nativeBridge, programmaticMraidCampaign, gdprManager, true, false, true);
