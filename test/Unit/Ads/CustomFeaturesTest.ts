...
describe('CustomFeatures', () => {
    ...
    describe('isSliderEndScreenEnabled', () => {
        it('should return false for iOS 9.0 if ab group is 7 and targetGameAppStoreId is in the SliderEndScreenTargetGameIds.', () => {
            const isEnabled = CustomFeatures.isSliderEndScreenEnabled(toAbGroup(7), '547145938', '9.0', Platform.IOS);
            assert.isFalse(isEnabled);
        });

        it('should return false for Android 7.0 if ab group is 7 and targetGameAppStoreId is in the SliderEndScreenTargetGameIds.', () => {
