...
describe('CampaignRefreshManager', () => {
    ...
    describe('On Promo', () => {
        ...
        it('should mark a placement for a promo campaign as ready', () => {
            ...
            sinon.stub(campaignManager, 'request').callsFake(() => {
                campaignManager.onCampaign.trigger('promoPlacement', TestFixtures.getPromoCampaign(PromoCampaignParser.ContentType), undefined);
                return Promise.resolve();
            });
            ...
            return campaignRefreshManager.refresh().then(() => {
                ...
                if (tmpCampaign) {
                    ...
                    assert.equal(tmpCampaign.getAdType(), PromoCampaignParser.ContentType);
                }
