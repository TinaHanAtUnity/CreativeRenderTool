...
[Platform.ANDROID, Platform.IOS].forEach(platform => {
    describe('OMUtilities', () => {
        ...
        //         const calculatedAdView: IAdView = om.calculateVastAdView(100, [], 200, 100, false, [], TestFixtures.getCompanionStaticVastCampaign());
        ...
        //         const calculatedAdView: IAdView = om.calculateVastAdView(100, [], 100, 200, false, [], TestFixtures.getCompanionStaticVastCampaign());
        //         const testAdView: IAdView = {
        //             percentageInView: 100,
        //             geometry: {
        //                 x: 0,
        ...
        //         const calculatedAdView: IAdView = om.calculateVastAdView(50, [ObstructionReasons.OBSTRUCTED], 200, 100, false, [obstructionRectangle], TestFixtures.getCompanionStaticVastCampaign());
        //         const testAdView: IAdView = {
        //             percentageInView: 50,
        //             geometry: {
        //                 x: 0,
        ...
        //         const calculatedAdView: IAdView = om.calculateVastAdView(100, [], 200, 100, true, [], TestFixtures.getCompanionStaticVastCampaign());
        //         const testAdView: IAdView = {
        //             percentageInView: 100,
        //             geometry: {
        //                 x: 0,
