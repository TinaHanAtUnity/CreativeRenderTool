...
describe('PromoEventsTest', () => {
    ...
    beforeEach(() => {
        ...
        promoEvents = new PromoEvents(coreConfig, adsConfig, nativeBridge, clientInfo, deviceInfo, analyticsStorage);
    });
    ...
    describe('getAppStoreFromReceipt', () => {
        ...
        it('should return \"unknown\" when given corrupt JSON', () => {
            ...
            assert.equal(appStore, 'unknown');
            sinon.assert.calledOnce(<sinon.SinonStub>sdk.logError);
        });
    });
