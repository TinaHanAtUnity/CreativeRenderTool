...
describe('Event parameters should match specifications', () => {
    ...
    describe('with ad request', () => {
        ...
        it('on Android', () => {
            ...
            const backupCampaignManager: BackupCampaignManager = new BackupCampaignManager(nativeBridge);
            ...
            const campaignManager: CampaignManager = new CampaignManager(nativeBridge, configuration, assetManager, sessionManager, adMobSignalFactory, request, clientInfo, deviceInfo, metaDataManager, cacheBookkeeping, jaegerManager, backupCampaignManager);
